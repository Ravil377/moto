...
/* harmony import */ var _modal_modal__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modal_modal__WEBPACK_IMPORTED_MODULE_4__);
...
var $phoneMask1 = document.querySelector('.phone-mask1--js');
var $phoneMask2 = document.querySelector('.phone-mask2--js');
...
var modalForm = document.querySelector(".modal__form--js");
var connectionForm = document.querySelector('.connection__form--js');
var supportForm = document.querySelector('.support__form--js');
var modalFormValidationSetting = {
...
var connectionFormValidationSetting = {
...
var supportFormValidationSetting = {
...
if (supportForm) {
  var supportFormFormValidation = new FormValidator(supportFormValidationSetting, supportForm);
  supportFormFormValidation.enableValidation();
}

if (connectionForm) {
  var connectionFormValidation = new FormValidator(connectionFormValidationSetting, connectionForm);
  connectionFormValidation.enableValidation();
}

if (modalForm) {
  var modalFormValidation = new FormValidator(modalFormValidationSetting, modalForm);
...
var $mainmenu = document.querySelector('.header-js');
...
enquire_js__WEBPACK_IMPORTED_MODULE_0___default().register('screen and (max-width: 993px)', {
  // deferSetup: true,
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs]);
